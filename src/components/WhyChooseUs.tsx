...
const reasons = [
  {
    icon: <ShieldCheck size={30} md:size={40} />,
  ...
  {
    icon: <Laptop size={30} md:size={40} />,
  ...
  {
    icon: <Trophy size={30} md:size={40} />,
  ...
  {
    icon: <HeartHandshake size={30} md:size={40} />,
    title: "Regular PTMs",
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-2xl md:text-4xl md:text-5xl font-bold text-primary mb-6 font-heading"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              {/* Content */}
              <div className="absolute inset-0 p-4 md:p-8 flex flex-col justify-end text-white translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                <div className="mb-4 bg-accent/20 w-12 md:w-16 h-12 md:h-16 rounded-2xl flex items-center justify-center backdrop-blur-md border border-white/20 group-hover:bg-accent group-hover:text-primary transition-all duration-500">
                  {reason.icon}
                </div>
