        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-6">
              {news.map((item, index) => (
                ...
                >
                  <div className="bg-gray-100 p-4 rounded-2xl text-primary group-hover:bg-accent transition-colors">
          ...
          <div className="bg-primary rounded-[3rem] p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <button className="mt-12 bg-white text-primary px-8 py-4 rounded-full font-bold hover:bg-accent transition-all w-full">
