    ...
    <div>
      ...
      <section className="md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="md:text-4xl text-2xl font-bold text-primary mb-6">Safe & Reliable Transport</h2>
            ...
            <ul className="space-y-4">
              {["GPS Tracking", "Trained Drivers", "Female Attendants", "Regular Maintenance"].map((item, i) => (
                <li key={i} className="flex items-center space-x-3 font-bold text-primary mb-5">
